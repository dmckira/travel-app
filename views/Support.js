...
function Support({navigation}){
 ...
 const bodySupport = `Hola, mi nombre es ${name}, mi correo es ${email}, y mi número de celular es ${cel} y me comunico el dia de hoy por la siguiente razón:
 ${description}`;
 ...
 const help = () => {
   if(description == '' && title == ''){
     ...
     sendEmail(emailSupport,title,bodySupport);
   }
 }
